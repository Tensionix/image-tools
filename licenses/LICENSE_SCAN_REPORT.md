...
- Project: **Audion Image Tools** (`audion-image-tools`)
- Run: `20260824T174256Z_audion-image-tools_75235447`
- Project root: `S:\Release\Audion Image Tools`
- Scan root: `S:\Release\Audion Image Tools`
- Output: `S:\Release\Audion Image Tools\licenses`
- Status: **PASS**
- Components: 85
- Bundled: 85
- Optional runtime: 0
...
| img2pdf | `NEW_COMPONENT_APPROVED_PROFILE` | - | 0.6.3 |
...
| pikepdf | `NEW_COMPONENT_APPROVED_PROFILE` | - | 10.12.0 |
| pillow | `NEW_COMPONENT_APPROVED_PROFILE` | - | 12.3.0 |
| pillow_heif | `NEW_COMPONENT_APPROVED_PROFILE` | - | 1.5.0 |
...
| rawpy | `NEW_COMPONENT_APPROVED_PROFILE` | - | 0.27.0 |
